...
export default function AIAssistant() {
  ...
  const generateAIResponse = async (userMessage: string): Promise<string> => {
    ...
    if (lowerMessage.includes('contract')) {
      ...
      return `Evidence law in Nigeria is governed by the Evidence Act of 2011. The Act establishes rules for what evidence is admissible in court proceedings.\n\nKey principles:\n- Relevance: Evidence must be relevant to the case\n- Admissibility: Must meet legal requirements\n- Weight: The persuasive power of evidence\n- Burden of proof: Who must prove what\n\nTypes of evidence include documentary, oral, real, and demonstrative evidence. Each has specific rules governing its admissibility.`;
    } else {
      return `I understand you're asking about: "${userMessage}". This is an important legal topic that requires careful consideration.\n\nIn Nigerian legal practice, this issue is governed by relevant statutes and case law. The courts have established precedents that help guide how such matters are handled.\n\nTo provide you with the most accurate and helpful response, could you provide more specific details about your situation or the particular aspect you'd like to explore? I'm here to help you navigate the complexities of the Nigerian legal system.`;
    }
  };
