...
class AbujaHighCourtScraper:
    """Scraper for Federal Capital Territory High Court"""

    def __init__(self):
        self.base_url = "https://abujacourts.gov.ng"
    ...
    async def scrape_judgments(self) -> List[Dict[str, Any]]:
        """Scrape court judgments from Abuja High Court"""
    ...
    async def scrape_cause_list(self, date: str = None) -> List[Dict[str, Any]]:
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            try:
                ...
                print(f"Error scraping Abuja cause list: {e}")
    ...
    def _extract_cause_list_data(self, element) -> Dict[str, Any]:
        ...
        try:
            ...
            court = court_elem.text.strip() if court_elem else "Abuja High Court"
    ...
    def _get_mock_judgments(self) -> List[Dict[str, Any]]:
        ...
        return [
            {
                "case_title": "Federal Government v. Oil Companies",
                "court": "Abuja High Court (FCT)",
                "date": "2026-01-12",
                "judge": "Justice E. Ibrahim",
                "citation": "[2026] FCTHC 1",
    ...
    def _get_mock_cause_list(self) -> List[Dict[str, Any]]:
        ...
        return [
            {
                "case_number": "FCT/HC/789/2026",
                "parties": "Nigerian Bar Association v. Attorney General of Federation",
                "court": "Abuja High Court - Central District",
                "hearing_date": "2026-01-25",
                "judge": "Justice F. Mohammed",
                "scraped_at": datetime.now().isoformat()
            }
        ]