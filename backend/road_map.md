...
Dashboard contains 5 cards:

Card 1: Legal Research
- search bar
- quick stats
- button: Search Judgments
...
- list of scenarios
- button: Start Video Interaction

Card 4: Legal Drafting AI
- Generate Motion
- Generate Affidavit
- Generate Written Address
...
→ AI judge asks question
→ user responds
→ dialogue saved
→ scoring engine evaluates
AI Video Courtroom
AI generated judge video
...
One more thing (this is important for your idea):

Your AI video courtroom + moot court training concept is actually very powerful. If built well, your platform could become something like:
